export default function About() {
  return (
    <section id="about" className="relative bg-surface-container-lowest py-24 overflow-hidden">
      {/* Left kente accent */}
      <div
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="w-full h-full relative">
                ...
                />
                <div className="w-full h-full bg-surface-container-high flex items-end justify-start p-4">
          ...
          <div className="space-y-6">
            ...
            {/* Body */}
            <div className="space-y-4 font-body text-on-surface-variant" style={{ lineHeight: 1.75 }}>
              <p>
                As a Canadian software engineer of Guinean heritage, my work exists at the
                intersection of high-performance technical architecture and profound cultural
                identity. I approach every codebase with the same tactical precision I honed
                as a competitive athlete.
              </p>
              <p>
                To me, building is not just about execution — it is about lineage. It is about
                translating the resilience of my West African roots into digital systems that are
                as enduring as they are elegant. My focus remains unwavering: creating products
                that resonate with human purpose and technical excellence.
              </p>
            </div>
