...
export const projects = [
  {
    id: '01',
    title: 'Spark-Solution',
    description: 'A smart parking solution delivering real-time spot availability and sensor-driven navigation — architected end-to-end from frontend UI and Spring backend to Rust-powered sensor firmware, backed by Redis and Postgres.',
    stack: ['VITE', 'REACT', 'JAVA', 'SPRING', 'RUST', 'REDIS', 'POSTGRES'],
    link: '#',
    image: null,
  },
  {
  ...
  },
  {
    ...
    stack: ['PYTHON', 'PYTORCH', 'FLASK', 'REACT', 'DOCKER', 'RTL', 'CYPRESS'],
    link: '#',
    image: null,
  },
  {
    ...
    stack: ['C++', 'ARDUINO', 'NODE.JS', 'JAVASCRIPT', 'HTML'],
    link: '#',
    image: null,
  },
];
